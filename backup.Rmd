      ...
      tabItem(tabName = "maptable",
              fluidRow(
                box(width = 12, 
                  ...
                  #  downloadButton("download_map_img", "Download Map as PNG",
                  #                 style = "color:white; background-color:#008CBA; font-weight:bold; font-size:16px; padding:10px 20px;")
                    ) # widened map box
              ),
              fluidRow(
                box(width = 12,
...
output$score_plot <- renderPlot({
  ...
  ggplot(df, aes(x = Basin, y = `Total Score`, color = ColorClass)) +
    ...
    labs(x = "Basin", y = "Total Score", title = "Subwatershed Ranking ")
})
